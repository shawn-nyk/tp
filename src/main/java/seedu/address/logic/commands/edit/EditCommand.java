...
import static seedu.address.logic.parser.clisyntax.GeneralCliSyntax.PREFIX_TAG;
 ...
 */
public class EditCommand extends EditCommandAbstract {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (!personToEdit.isSameItem(editedPerson) && model.getAddressBook().hasItem(editedPerson)) {
            throw new CommandException(MESSAGE_DUPLICATE_PERSON);
        }

        model.getAddressBook().setItem(personToEdit, editedPerson);
        model.getAddressBook().updateFilteredItemList(PREDICATE_SHOW_ALL_ITEMS);
