...
public class ClearCommandTest {
    ...
    @Test
    public void execute_emptyInternHunter_success() {
    ...
    @Test
    public void execute_nonEmptyInternHunter_success() {
        Model model = new ModelManager(new ItemList<>(), getSampleApplicationItemList(), new ItemList<>(),
            new UserPrefs());
        Model expectedModel = new ModelManager(new ItemList<>(), getSampleApplicationItemList(), new ItemList<>(),
            new UserPrefs());
