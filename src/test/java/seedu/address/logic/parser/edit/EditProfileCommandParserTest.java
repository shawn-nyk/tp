...
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.CATEGORY_DESC_SKILL;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.DESCRIPTOR_DESC_IMPLEMENT;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.DESCRIPTOR_DESC_LEARN;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.INVALID_CATEGORY_DESC;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.INVALID_DESCRIPTOR_DESC;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.INVALID_TITLE_DESC;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.TITLE_DESC_COMPETITION;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.TITLE_DESC_INTERNSHIP;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_CATEGORY_ACHIEVEMENT;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_CATEGORY_EXPERIENCE;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_CATEGORY_SKILL;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_DESCRIPTOR_IMPLEMENT;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_DESCRIPTOR_LEARN;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_TITLE_COMPETITION;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_TITLE_HTML;
import static seedu.address.logic.commands.util.profile.ProfileCommandTestUtil.VALID_TITLE_INTERNSHIP;
...
import seedu.address.testutil.profile.EditProfileItemDescriptorBuilder;
